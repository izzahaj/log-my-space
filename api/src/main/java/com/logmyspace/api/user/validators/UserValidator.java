...
public class UserValidator {
  ...
  private static final String USERNAME_LENGTH_MESSAGE =
      String.format("Username must be between %d and %d characters.", MINIMUM_USERNAME_LENGTH,
          MAXIMUM_USERNAME_LENGTH);
  private static final String USERNAME_PATTERN_MESSAGE = String.format(
  ...
  public static void validateUsername(String username) {
    ...
    boolean isValidLength = username.length() >= MINIMUM_USERNAME_LENGTH
