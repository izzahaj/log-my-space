 ...
 *
 * <p>This class provides common fields and methods related to entity auditing such as creation timestamp,
 * last modified timestamp, and lifecycle callbacks for setting the timestamps.</p>
 *
...
public abstract class BaseEntity {
    ...
    /**
     * Sets the creation and last modified timestamps to the current UTC time.
     * This callback method is automatically invoked before persisting the entity.
     */
    @PrePersist
    ...
    /**
     * Sets the last modified timestamp to the current UTC time.
     * Callback method automatically invoked before updating the entity.
     */
    @PreUpdate
